...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen w-full font-serif flex justify-center items-center bg-[#021822] overflow-hidden">
      <div
        className={`relative bg-transparent w-180 h-90 mt-24 border border-cyan-400 shadow-[0_0_20px_cyan] overflow-hidden transform transition-transform duration-700 ease-in-out ${
      ...
      >
        ...
        <form
          ...
          className="absolute right-0 w-1/2 h-full p-6 flex flex-col justify-center"
        >
        ...
        {/* Welcome message */}
        <div className="absolute top-0 left-0 h-full flex flex-col justify-center text-right p-[4px_40px_60px_150]">
          <h2 className="text-2xl text-left pl-4 text-amber-50 leading-[1.3] uppercase">
            Join Us!
          </h2>
          <p className="text-base text-amber-50 pl-2">
